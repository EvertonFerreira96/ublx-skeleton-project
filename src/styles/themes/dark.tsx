...
export default {
    ...
    typography: {
        little: {
            light: {
                size: RFValue(PixelRatio.getFontScale() * 12),
        ...
        small: {
            light: {
                size: RFValue(PixelRatio.getFontScale() * 14),
                lineHeight: RFValue(PixelRatio.getFontScale() * 20),
                fontFamily: 'Inter_400Regular',
            },
            natural: {
        ...
        regular: {
            light: {
                size: RFValue(PixelRatio.getFontScale() * 16),
        ...
        medium: {
            natural: {
                size: RFValue(PixelRatio.getFontScale() * 18),
                lineHeight: RFValue(PixelRatio.getFontScale() * 24),
                fontFamily: 'Inter_500Medium',
            }
        },
        large: {
            natural: {
                size: RFValue(PixelRatio.getFontScale() * 24),
